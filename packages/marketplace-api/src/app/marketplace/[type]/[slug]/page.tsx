    ...
    <div className="flex-1 flex flex-col font-sans text-gray-200">
      ...
      <div className="border-b border-white/[0.08] bg-[#161b22]">
        <div className="max-w-5xl w-full mx-auto px-8 flex gap-8">
          <button className="px-1 py-4 border-b-2 border-emerald-500 text-white font-medium text-sm">Overview</button>
          <button className="px-1 py-4 border-b-2 border-transparent text-gray-400 hover:text-gray-300 text-sm">Version History</button>
