...
import { Search, Download, Loader2, Package, Palette, CheckCircle2, Clock } from 'lucide-react';
        ...
        <div className="relative border border-slate-200 rounded-xl p-6 bg-white min-h-[400px] flex-1">
          ...
          <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
            ...
            {sortedLocalThemes.map(theme => {
              ...
              return (
                <Card key={theme.slug} size="sm" className={`pt-0 h-full overflow-hidden shadow-sm transition-all border-transparent ${isActive ? 'shadow-lg shadow-emerald-500/20' : 'hover:shadow-md'}`}>
            ...
            {filteredMarketplace.map(theme => {
              return (
                <Card key={theme.id} size="sm" className="pt-0 h-full overflow-hidden shadow-sm transition-all border-transparent hover:shadow-md">
